...
- Test feature to trigger release action ([#127](https://github.com/BrickUIApp/BrickUIApp/pull/127))
- Test feat to trigger release action ([#135](https://github.com/BrickUIApp/BrickUIApp/pull/135))
- Fake feature to trigger release-plz
- Fake feature to trigger release-plz
- Fake feature to trigger release-plz
- Fake feat to trigger release-plz
- Fake feature to trigger release-plz
- Fake feature to trigger release-plz
- Fake feature to trigger release-plz
...
- Fake feature to trigger release-plz
- Fake feature to trigger release-plz
- Tauri build now use Cargo.toml version
- Trigger again 0.1.1 release
...
- Release-plz
- Fake fix to trigger release-plz
- Fake fix to trigger release-plz
- Cargo.toml version
...
- Release v0.1.0
- *(release)* Brickui v0.1.0
- *(release)* Brickui v0.1.0
- *(release)* Brickui v0.1.0 ([#66](https://github.com/BrickUIApp/BrickUIApp/pull/66))
- *(release)* Brickui v0.1.0 ([#74](https://github.com/BrickUIApp/BrickUIApp/pull/74))
- *(release)* Brickui v0.1.0 ([#115](https://github.com/BrickUIApp/BrickUIApp/pull/115))
